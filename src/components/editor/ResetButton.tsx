...
export function ResetButton({ what, onReset }: ResetButtonProps) {
  return (
    <button
      ...
      className="sg-reset grid h-[17px] w-[17px] shrink-0 place-items-center rounded-full text-sg-muted transition-colors hover:bg-white/10 hover:text-text focus-visible:outline-2 focus-visible:outline-offset-1 focus-visible:outline-white/60"
    >
