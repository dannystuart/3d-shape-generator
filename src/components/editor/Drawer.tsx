...
export function Drawer({ open, onOpenChange, hidden, overlay, children }: DrawerProps) {
  return (
    <aside
      className="sg-drawer relative shrink-0 overflow-hidden"
      data-open={open}
    ...
    >
      ...
      <div
        className="sg-drawer__inner absolute inset-y-0 right-0 flex flex-col"
        inert={!open}
      >
        {children}
        ...
        <div className="sg-glow" aria-hidden />
      </div>
