...
describe("a slider", () => {
  ...
  it("puts the mark where the value is, as a fraction of the range", () => {
    ...
    const capsule = container.querySelector(".sg-slider") as HTMLElement;
  ...
  it("draws a centred dial with a middle to aim at and no fill", () => {
    ...
    expect(container.querySelector(".sg-slider__centre")).not.toBeNull();
    expect(container.querySelector(".sg-slider__fill")).toBeNull();
  });
