...
export function Slider({
  ...
  return (
    <div className="sg-slider" style={{ ["--k" as string]: k }}>
      <span className="sg-slider__ticks" aria-hidden />
      {centred ? (
        <span className="sg-slider__centre" aria-hidden />
      ) : (
        <span className="sg-slider__fill" aria-hidden />
      )}
      <span className="sg-slider__mark" aria-hidden />

      <label htmlFor={id} className="sg-slider__label truncate text-[12.5px] leading-none text-sg-text">
        {label}
      </label>

      <span className="sg-slider__value flex shrink-0 items-center gap-1.5">
        ...
        <span
          ...
          className={`select-none font-sg-mono text-[11px] tabular-nums leading-none text-sg-muted ${
