...
describe("the tool drawer", () => {
  ...
  it("takes its contents out of the flow so the travel cannot squash them", () => {
    ...
    const inner = container.querySelector(".sg-drawer__inner") as HTMLElement;
  ...
  it("puts its contents beyond reach while it is shut", () => {
    ...
    expect(container.querySelector(".sg-drawer__inner")).toHaveAttribute("inert");
    ...
    expect(container.querySelector(".sg-drawer__inner")).not.toHaveAttribute("inert");
  });
  ...
  it("goes with everything else when the screen is cleared", () => {
    ...
    expect(container.querySelector(".sg-drawer")).toHaveAttribute("data-hidden");
  });
});
