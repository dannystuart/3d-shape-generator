...
/**
 * Visual baselines for the catalogue and the effects.
 *
 * The unit tests confirm the numbers; only a picture catches "a geometry change
 * quietly ruined the torus". Chromium only and one device scale — this
 * is a regression net, not a cross-browser matrix, and the browsers that
 * composite 3D differently get looked at by a person before launch.
 */
